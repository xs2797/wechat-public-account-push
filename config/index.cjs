...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wx5c00a5b4c58edb30',

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: '8ea467dc5625d7736736eb246272edab',
  ...
  USERS: [
    {
      ...
      id: 'oZ1Ns5hcVGgeuLGsW--HDY9BBkGY',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: 'Sb6hA8q2Fp3vqrndq2BwiM6L9brpsOiXGzn0Y-0RwJY',
      // 所在省份
      province: '广东',
      // 所在城市
      city: '肇庆',
